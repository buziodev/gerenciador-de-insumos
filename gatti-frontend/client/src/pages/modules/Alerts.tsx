/** Página de alertas com ações condicionadas à permissão de atualização. */
...
export default function AlertsPage() {
  ...
  const canUpdate = useCanAccess('alerts', 'update');

...
export default function StockPage() {
  ...
  const canCreate = useCanAccess('stock', 'create');
  ...
  return <div className="space-y-6">
    <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center"><div><h1 className="text-3xl font-bold">Estoque</h1><p className="text-muted-foreground">Registre entradas, saídas e demais movimentações de suprimentos.</p></div>{canCreate ? <Button onClick={() => setOpen(true)}><Plus className="mr-2 h-4 w-4" />Nova movimentação</Button> : null}</div>
